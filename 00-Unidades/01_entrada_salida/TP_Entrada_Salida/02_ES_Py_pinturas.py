...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        primerpaso = centigrados * 9/5

        segundopaso = primerpaso + 32


        alert("De °C a °F", f"El cambio de grados da por resultado {segundopaso} °F")
    ...
    def btn_convertir_f_c_on_click(self):
        ...
        primerpaso = fahrenheit - 32

        segundopaso = primerpaso * 5/9


        alert("De °F a °C", f"El cambio de grados da por resultado {segundopaso} °C")
